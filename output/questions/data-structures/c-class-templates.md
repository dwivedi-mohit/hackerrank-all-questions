...
- **Difficulty:** Easy
- **Max Score:** 20
- **Success Ratio:** 0.8485287350098806
- **Total Submissions:** 73882
- **Solved Count:** 62691
- **URL:** https://www.hackerrank.com/challenges/c-class-templates
...
$1.0 \le value_{float} \le 10.0$, where $value_{float}$ is any float value  
$1 \le value_{int} \le 10^5$, where value<sub>int</sub> is any int value  
...
"Doe" when appended with "John" gives "JohnDoe".
2 added to 1 gives 3, and 1.5 added to 4.0 gives 5.5.
