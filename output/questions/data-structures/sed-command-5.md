...
- **Difficulty:** Hard
- **Max Score:** 2
- **Success Ratio:** 0.9792481203007519
- **Total Submissions:** 23275
- **Solved Count:** 22792
- **URL:** https://www.hackerrank.com/challenges/sed-command-5

## Problem Statement

[Sed](http://en.wikipedia.org/wiki/Sed) is a popular utility which enables quick parsing and transformation of text.  
...
**Useful References:**
[This particular page on StackOverflow](http://stackoverflow.com/questions/2232200/regular-expression-in-sed-for-masking-credit-card) has a relevant example about sed, groups and backreferences. [Here's](http://www.thegeekstuff.com/2009/10/unix-sed-tutorial-advanced-sed-substitution-examples/) a detailed tutorial covering groups and backreferences.  
