...
| **Difficulty** | Hard |
| **Score** | 60 |
| **URL** | https://www.hackerrank.com/challenges/balanced-forest |

---

## Preview

Determine the minimum number of coins to add to a tree such that it can be cut into three trees having an equal number of coins.
...
![image](https://s3.amazonaws.com/hr-assets/0/1528138409-097321b50e-forestExample.png)
...
- The second line contains $n$ space-separated integers describing the respective values of $c[1], c[2], \ldots, c[n]$, where each $c[i]$ denotes the value at node $i$.
...
For $\text{30%}$ of the maximum score:
