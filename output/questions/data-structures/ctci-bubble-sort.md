...
- **Difficulty:** Easy
- **Max Score:** 30
- **Success Ratio:** 0.9735112831745708
- **Total Submissions:** 255203
- **Solved Count:** 248443
...
**Explanation 1**				
The array is *not sorted*, and its initial values are: $\text{\{3, 2, 1\}}$. The following $3$ swaps take place:

1. $\text{\{3, 2, 1\}} \rightarrow \text{\{2, 3, 1\}}$
2. $\text{\{2, 3, 1\}} \rightarrow \text{\{2, 1, 3\}}$
3. $\text{\{2, 1, 3\}} \rightarrow \text{\{1, 2, 3\}}$
