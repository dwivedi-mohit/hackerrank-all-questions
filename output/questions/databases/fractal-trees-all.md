...
- **Difficulty:** Hard
- **Max Score:** 30
- **Success Ratio:** 0.9261571761571762
- **Total Submissions:** 24024
- **Solved Count:** 22250
- **URL:** https://www.hackerrank.com/challenges/fractal-trees-all
...
**Output Format**  
The N<sup>th</sup> iteration of the Fractal Tree, as shown above. It should be a matrix of 63 rows and 100 columns. (i.e. 6300 printable characters)
