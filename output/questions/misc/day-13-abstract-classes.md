...
| Field | Value |
|---|---|
| **Slug** | `day-13-abstract-classes` |
| **Contest** | 30-days-of-code |
| **Difficulty** | Easy |
| **Score** | 75 |
| **URL** | https://www.hackerrank.com/challenges/day-13-abstract-classes |

---

## Problem Statement

Welcome to Day 13! Check out [this video](https://youtu.be/xSQKDWTahvs) reviewing [abstract classes](https://docs.oracle.com/javase/tutorial/java/IandI/abstract.html), or just jump into the problem. It's important to understand [Inheritance](https://docs.oracle.com/javase/tutorial/java/IandI/subclasses.html) before attempting this challenge. 
