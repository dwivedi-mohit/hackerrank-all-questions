...
| Field | Value |
|---|---|
| **Slug** | `one-month-preparation-kit-merge-two-sorted-linked-lists` |
| **Domain** |  |
| **Difficulty** | Easy |
| **Score** | 100 |
| **URL** | https://www.hackerrank.com/challenges/one-month-preparation-kit-merge-two-sorted-linked-lists |
