...
| Field | Value |
|---|---|
| **Slug** | `one-month-preparation-kit-reverse-a-doubly-linked-list` |
| **Domain** |  |
| **Difficulty** | Easy |
| **Score** | 100 |
| **URL** | https://www.hackerrank.com/challenges/one-month-preparation-kit-reverse-a-doubly-linked-list |
