...
| Field | Value |
|---|---|
| **Slug** | `three-month-preparation-kit-hackerland-radio-transmitters` |
| **Domain** |  |
| **Difficulty** | Medium |
| **Score** | 100 |
| **URL** | https://www.hackerrank.com/challenges/three-month-preparation-kit-hackerland-radio-transmitters |
