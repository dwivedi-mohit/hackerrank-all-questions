...
| Field | Value |
|---|---|
| **Slug** | `three-month-preparation-kit-misere-nim-1` |
| **Domain** |  |
| **Difficulty** | Easy |
| **Score** | 100 |
| **URL** | https://www.hackerrank.com/challenges/three-month-preparation-kit-misere-nim-1 |

---

## Preview

A Nim game where you lose if you take the last stone.
