...
| Field | Value |
|---|---|
| **Slug** | `day-21-generics` |
| **Contest** | 30-days-of-code |
| **Difficulty** | Easy |
| **Score** | 75 |
| **URL** | https://www.hackerrank.com/challenges/day-21-generics |

---

## Problem Statement

Welcome to Day 21! Check out [a video review of generics here](https://youtu.be/Z9uAwnz_wBA), or just jump right into the problem.
