...
| Field | Value |
|---|---|
| **Slug** | `day-4-boolean-operators-class-vs-instance` |
| **Contest** | 30-days-of-code |
| **Difficulty** | Easy |
| **Score** | 30 |
| **URL** | https://www.hackerrank.com/challenges/day-4-boolean-operators-class-vs-instance |
...
You will create a class *Person* and write a constructor that takes an integer, *initial\_Age*. In this constructor, you should check that the *initial\_Age* is not negative because we can't have people with negative ages.
