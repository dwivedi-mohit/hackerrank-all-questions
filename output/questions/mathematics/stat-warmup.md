...
- **Difficulty:** Easy
- **Max Score:** 10
- **Success Ratio:** 0.8717120028727893
- **Total Submissions:** 11139
- **Solved Count:** 9710
- **URL:** https://www.hackerrank.com/challenges/stat-warmup
...
4. **Standard Deviation (SD)**.
    ...
    SD = (((x<sub>1</sub>-m)<sup>2</sup>+(x<sub>2</sub>-m)<sup>2</sup>+(x<sub>3</sub>-m)<sup>2</sup>+(x<sub>4</sub>-m)<sup>2</sup>+...(x<sub>N</sub>-m)<sup>2</sup>))/N)<sup>0.5</sup>  

    where x<sub>i</sub> is the i<sup>th</sup> element of the array  
...
[(iframe youtube 5C9LBF3b65s 560 315)]  

**Standard Deviation**  

[(iframe youtube dq_D30kyR1A 560 315)]  

**Confidence Intervals: Getting a bit more serious!**  
[(iframe youtube tFWsuO9f74o 560 315)]  
