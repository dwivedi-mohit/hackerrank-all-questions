...
- **Difficulty:** Easy
- **Max Score:** 25
- **Success Ratio:** 0.9637668715870453
- **Total Submissions:** 58234
- **Solved Count:** 56124
- **URL:** https://www.hackerrank.com/challenges/preprocessor-solution
...
The second line contains $N$ space-separated integers, $x_1, x_2, \ldots, x_n$, describing the elements in the array.

## Output Format

You are not responsible for printing any output to stdout. Once the necessary preprocessor macros are written, the locked code in your editor will print a line that says $\texttt{Result = Z}$, where $Z$ is the difference between the maximum and minimum values in the array.
