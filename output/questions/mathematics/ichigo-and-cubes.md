...
| Field | Value |
|---|---|
| **Slug** | `ichigo-and-cubes` |
| **Domain** | mathematics |
| **Difficulty** | Medium |
| **Score** | 60 |
| **URL** | https://www.hackerrank.com/challenges/ichigo-and-cubes |

---

## Preview

Find the number of cubes cut off by Ichigo
...
![cube](https://hr-challenge-images.s3.amazonaws.com/ichigo-cube.jpg)
...
For each test case, print a single integer in a new line that is the number of cubes that were cut by Ichigo modulo (10<sup>9</sup> + 7).

**Constraints:**

1 <= T <= 1000

1 <= P, Q, R <= 10<sup>12</sup>
