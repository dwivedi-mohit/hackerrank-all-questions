...
- **Difficulty:** Easy
- **Max Score:** 25
- **Success Ratio:** 0.9226908090763236
- **Total Submissions:** 43630
- **Solved Count:** 40257
- **URL:** https://www.hackerrank.com/challenges/js10-buttons-container
...
__Task__	
We want to create nine buttons enclosed in a *div*, laid out so they form a $3 \times 3$ grid. Each button has a distinct label from $1$ to $9$, and the labels on the outer buttons must rotate in the *clockwise* direction each time we click the middle button.

Complete the code in the editor so that it satisfies the following criteria:

- *Initial State.* The initial layout looks like this:	
	![layout](https://s3.amazonaws.com/hr-challenge-images/0/1456631615-634977c808-ScreenShot2016-02-28at9.22.14AM.png)
...
- *Styling.* The document's elements must have the following styles:
	- The `width` of `btns` is $\text{75%}$, relative to the document body's width.		
    - Each button (i.e., `btn1` through `btn9`) satisfies the following:
        - The `width` is $\text{30%}$, relative to its container width.
        - The `height` is `48px`.
