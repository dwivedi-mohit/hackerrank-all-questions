...
- **Difficulty:** Hard
- **Max Score:** 100
- **Success Ratio:** 0.7779030439684329
- **Total Submissions:** 4435
- **Solved Count:** 3450
- **URL:** https://www.hackerrank.com/challenges/one-month-preparation-kit-no-prefix-set
...
**Constraints**  
$1 \le n \le 10^5$   
$1 \le $ the length of words[i] $\le 60$   
