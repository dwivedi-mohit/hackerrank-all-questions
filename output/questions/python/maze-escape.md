...
- **Difficulty:** Medium
- **Max Score:** 100
- **Success Ratio:** 0.12182522600086096
- **Total Submissions:** 4646
- **Solved Count:** 566
- **URL:** https://www.hackerrank.com/challenges/maze-escape
...
5 <= r,c <= 30
where r, c is the number of rows and columns of the maze. 
...
Considering the maze given above. If the input is as given below with the bot initially facing the RIGHT side of the maze, if the bot chooses to go RIGHT, the new position of the bot in the maze 
would be 
...
Timelimits for each move is given [here](https://hr-assets.s3.amazonaws.com/7bb46cae_challenge_assets/checker_limits/951/limits.json)
