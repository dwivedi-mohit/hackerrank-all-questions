...
- **Difficulty:** Medium
- **Max Score:** 40
- **Success Ratio:** 0.7138542846357115
- **Total Submissions:** 2649
- **Solved Count:** 1891
- **URL:** https://www.hackerrank.com/challenges/salary-blues
...
Their current salaries are denoted by a sequence of **N** integers: **A<sub>1</sub>, A<sub>2</sub>, A<sub>3</sub> ... A<sub>N</sub>** .
