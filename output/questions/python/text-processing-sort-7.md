...
- **Difficulty:** Easy
- **Max Score:** 1
- **Success Ratio:** 0.9943437914273089
- **Total Submissions:** 33945
- **Solved Count:** 33753
- **URL:** https://www.hackerrank.com/challenges/text-processing-sort-7

## Problem Statement

You are given a file of **pipe-delimited** weather data (TSV). There is no header column in this data file. The first five columns of this data are:
