...
- **Tags:** Medium, Object-Oriented Programming, Inheritance, Static Methods, Implementation, async await, Classes, TypeScript, Objects, OOP
- **Skills:** TypeScript (Intermediate)
- **Languages:** t, y, p, e, s, c, r, i, p, t

## Summary

This coding question evaluates object-oriented programming, inheritance, and asynchronous methods concepts, ideal for mid-level roles. The task involves implementing TypeScript classes for managing bank accounts with specific functionalities and constraints.

## Problem Statement

An organization has partnered with a bank to develop software that manages bank accounts. As a developer, the task is implementing a TypeScript class BankStatement that supports various functions. Some properties should hidden (private), and others should be publicly accessible. Additionally, some functions, like transferring money between accounts, should be asynchronous.
...
- If to or from does not exist, return "Account not found".
