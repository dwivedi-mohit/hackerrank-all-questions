# Django REST Framework: Stock Trades API
...
- **Tags:** Hard, Back-End Development, Django REST Framework, Python 3
- **Skills:** Django (Advanced)

## Summary

This back-end development question evaluates REST API design, Django framework, and Python 3 concepts, ideal for senior-level roles. The problem requires implementing a REST API to manage stock trades with specific JSON structure and endpoints.
