...
- **Tags:** Back-End Development, Flask 1.1.2, Hard, Python 3.8, SQLAlchemy, Flask
- **Skills:** Flask (Advanced)

## Summary

This back-end development question evaluates REST API implementation, Flask framework, and JSON data handling concepts, ideal for senior-level roles. The problem requires creating a REST API to manage stock trades with specific endpoints and response behaviors.
...
`GET` request to `/trades?user_id=1`
