...
- **Tags:** Medium, Back-End Development, Flask 1.1.2, SQLAlchemy, Flask, Python 3.7
- **Skills:** Flask (Intermediate)

## Summary

This back-end development question evaluates REST API implementation, Flask, and SQLAlchemy concepts, ideal for mid-level roles. The problem requires creating a REST API to manage stock trades, handling various HTTP methods and responses.
