...
- **Tags:** Spring Boot, Medium, Back-End Development
- **Skills:** Spring Boot (Intermediate)

## Summary

This back-end development question evaluates REST API implementation, JSON handling, and trade management concepts, ideal for mid-level roles. The task involves creating a REST API to manage stock trades with specific endpoints and response requirements.
