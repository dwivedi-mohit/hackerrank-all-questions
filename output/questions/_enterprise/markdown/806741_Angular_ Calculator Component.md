...
- **Tags:** Angular, State Management, Medium, TypeScript, Front-End
- **Skills:** Angular (Intermediate)

## Summary

This front-end development question evaluates Angular, state management, and TypeScript concepts, ideal for mid-level roles. The problem requires creating a calculator component with specific functionalities and data-test-id attributes for testing.

## Problem Statement

Create a calculator component, as shown below.
