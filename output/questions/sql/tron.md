...
- **Difficulty:** Easy
- **Max Score:** 50
- **Success Ratio:** 0.26627218934911245
- **Total Submissions:** 1014
- **Solved Count:** 270
...
This version of Tron takes place on a 15x15 grid. Top left of the grid is (0,0) and the bottom right of the grid is indexed as (14,14). <br/>
...
The second line consists of four single spaced integers representing the current position of the 1st and 2nd  players' motorbike. <br/>15 lines follow which represents the grid map.<br/>
