...
- **Difficulty:** Medium
- **Max Score:** 100
- **Success Ratio:** 0.7941176470588235
...
The first line contains an integer x1, the bot's starting x coordinate.

The second line contains an integer y1, the bot's starting y coordinate.

The third line contains an integer x2, the bot's target x coordinate.

The fourth line contains an integer y2, the bot's target y coordinate.
