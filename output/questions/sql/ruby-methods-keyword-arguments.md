...
- **Difficulty:** Medium
- **Max Score:** 20
- **Success Ratio:** 0.9483515457177547
- **Total Submissions:** 10707
- **Solved Count:** 10154
- **URL:** https://www.hackerrank.com/challenges/ruby-methods-keyword-arguments
...
more](http://brainspec.com/blog/2012/10/08/keyword-arguments-ruby-2-0/)). Since
...
Also, introducing the *double splat* (\*\*) which similar to it's counterpart collects
all the extra named keywords as a hash parameter.
