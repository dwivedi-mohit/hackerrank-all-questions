...
| Field | Value |
|---|---|
| **Slug** | `day-1-data-types` |
| **Contest** | 30-days-of-code |
| **Difficulty** | Easy |
| **Score** | 30 |
| **URL** | https://www.hackerrank.com/challenges/day-1-data-types |

---

## Problem Statement

Welcome to Day 1! Check out the [video tutorial here](https://youtu.be/XLCka0noTY4), or just jump right into the problem. 
...
**Note:**
This challenge is focused only on Java data types, but you can submit the answer in other languages as well. Hint: In Java, $String$ is a $referenced$ type.
Most challenges in upcoming days are language-agnostic. 
