...
Minimal number of bullets required to complete N levels of the game if you kill one enemy at each level and use its bullet for current and just next level
