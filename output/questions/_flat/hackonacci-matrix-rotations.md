...
| Field | Value |
|---|---|
| **Slug** | `hackonacci-matrix-rotations` |
| **Domain** | mathematics |
| **Difficulty** | Medium |
| **Score** | 35 |
...
Fill a Hackonacci Matrix and count the number of cells that change after performing a rotation. Hint: use Matrix Exponentiation!
