...
| Field | Value |
|---|---|
| **Slug** | `calculating-volume` |
| **Domain** |  |
| **Difficulty** | Medium |
| **Score** | 20 |
| **URL** | https://www.hackerrank.com/challenges/calculating-volume |

---

## Preview

Calculate volume of some geometrical shapes. It will test your knowledge on various OOP concepts.
...
In case any of the *dimensions* of the figures are $ \le  0$, print *"java.lang.NumberFormatException: All the values must be positive"* without quotes and *terminate the program*.

*Note*: Use [Math.PI](http://docs.oracle.com/javase/7/docs/api/java/lang/Math.html#PI) or $3.14159265$ as the value of pi.
