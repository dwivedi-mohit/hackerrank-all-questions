...
| Field | Value |
|---|---|
| **Slug** | `three-month-preparation-kit-sherlock-and-valid-string` |
| **Domain** |  |
| **Difficulty** | Medium |
| **Score** | 100 |
| **URL** | https://www.hackerrank.com/challenges/three-month-preparation-kit-sherlock-and-valid-string |
