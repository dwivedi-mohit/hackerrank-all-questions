...
| Field | Value |
|---|---|
| **Slug** | `markov-snakes-and-ladders` |
| **Domain** | ai |
| **Difficulty** | Medium |
| **Score** | 40 |
| **URL** | https://www.hackerrank.com/challenges/markov-snakes-and-ladders |

---

## Preview

Markov is going to play a game of Snakes and Ladders, and the die is biased. The aim is to count the expected number of die rolls to move from Square 1 to 100.
...
1. Those who are not familiar with this game might get a decent idea from this Wikipedia page: [Snakes And Ladders](http://en.wikipedia.org/wiki/Snakes_and_Ladders)
...
This is followed by 4T lines. There are 4 lines per test configuration and in each test:
...
Since this is a problem involving simulation, a reasonable margin of deviation from these numbers will be tolerated, as explained in the scoring section.
For the first test, the expected number of die rolls to reach the destination square (100) is 160.
...
If there are N tests in a particular test case file,
your score will be:
