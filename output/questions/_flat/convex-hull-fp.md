...
(Geometry) Finding convex hull of a given set of points (Graham Scan Algorithm can be applied).

## Problem Statement

*Contributed by [Abhiranjan Kumar](https://www.hackerrank.com/abhiranjan)*
...
![Convex Hull](http://hr-testcases.s3.amazonaws.com/975 "Convex hull: elastic-band analogy") 
