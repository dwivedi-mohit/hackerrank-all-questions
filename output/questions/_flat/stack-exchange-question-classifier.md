...
| Field | Value |
|---|---|
| **Slug** | `stack-exchange-question-classifier` |
| **Domain** | ai |
| **Difficulty** | Medium |
| **Score** | 100 |
...
Stack Exchange has several topics, with thousands of great questions asked by members of the community. You are provided with questions which were asked - and you need to guess which Topic they belonged to.

## Problem Statement

[Stack Exchange](http://stackexchange.com/) is an information powerhouse, built on the power of crowdsourcing. It has [105 different topics](http://stackexchange.com/sites) and each topic has a library of questions which have been asked and answered by knowledgeable members of the StackExchange community. The topics are as diverse as travel, cooking, programming, engineering and photography.



![stackoverflow](https://s3.amazonaws.com/hr-assets/0/1526565905-535c8aa802-stackoverflow.png)

We have hand-picked [ten different topics](https://hr-testcases.s3.amazonaws.com/845/assets/poss_out.txt) (such as Electronics, Mathematics, Photography etc.) from Stack Exchange, and we provide you with a set of questions from these topics. 
...
The [training file](https://s3.amazonaws.com/hr-testcases/845/assets/training.json) is available here. It is also present in the current directory in which your code is executed. 
...
Sample testcases can be downloaded [here](https://hr-testcases.s3.amazonaws.com/845/assets/testcase.zip) for offline training. 
When you submit your solution to us, you can assume that the training file can be accessed by reading "training.json" which will be placed in the same folder as the one in which your program is being executed.
