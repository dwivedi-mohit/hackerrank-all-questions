...
Given two different arithmetic progressions, produce a third one by multiplying each element together. Then create new sequences by finding the difference between each element, until the sequence becomes a constant.
