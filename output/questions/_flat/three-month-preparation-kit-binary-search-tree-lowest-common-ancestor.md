...
| Field | Value |
|---|---|
| **Slug** | `three-month-preparation-kit-binary-search-tree-lowest-common-ancestor` |
| **Domain** |  |
| **Difficulty** | Easy |
| **Score** | 100 |
| **URL** | https://www.hackerrank.com/challenges/three-month-preparation-kit-binary-search-tree-lowest-common-ancestor |
