...
| Field | Value |
|---|---|
| **Slug** | `ruby-methods-arguments` |
| **Domain** | ruby |
| **Difficulty** | Medium |
| **Score** | 15 |
| **URL** | https://www.hackerrank.com/challenges/ruby-methods-arguments |

---

## Preview

Complete a method having default variable values based on a review of its inputs and outputs.
...
**In this challenge**, your task is to determine what the *take* method does.  Study the
examples below, then implement the method. 
...
The method can be invoked as `name('Foolan', 'Barik')` or,
without the parentheses, as `name 'Foolan', 'Barik'`.  The latter
convention can be confusing and is not recommended.
