...
| Field | Value |
|---|---|
| **Slug** | `employee-validation` |
| **Domain** | react |
| **Difficulty** | Medium |
| **Score** | 60 |
| **URL** | https://www.hackerrank.com/challenges/employee-validation |

---

## Preview

A react app that helps employees validate and update their existing information through a survey form
...
2. All input fields are cleared, the Submit button is disabled, and the form resets to its initial state.
