...
| **Difficulty** | Hard |
| **Score** | 60 |
| **URL** | https://www.hackerrank.com/challenges/react-word-omitter |

---

## Preview

Create an application that allows users to type text, and as they type, text will be displayed with certain words omitted.
