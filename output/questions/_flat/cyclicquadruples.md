...
Find the number of quadruples of integers, where each integer is in its own range, and every two consecutive elements of quadruple should be distinct. The first and last elements also should be distinct.
