...
| Field | Value |
|---|---|
| **Slug** | `cryptorank-exchange` |
| **Domain** | react |
| **Difficulty** | Medium |
| **Score** | 60 |
| **URL** | https://www.hackerrank.com/challenges/cryptorank-exchange |

---

## Preview

Create a React application called "CryptoRank Exchange" to estimate the cryptocurrency coins a user can receive based on an entered amount
