...
| Field | Value |
|---|---|
| **Slug** | `database-normalization-7` |
| **Domain** | databases |
| **Difficulty** | Medium |
| **Score** | 5 |
| **URL** | https://www.hackerrank.com/challenges/database-normalization-7 |

---

## Preview

Identify the normal form given relations and determinants.
