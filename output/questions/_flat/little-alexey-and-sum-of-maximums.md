...
| Field | Value |
|---|---|
| **Slug** | `little-alexey-and-sum-of-maximums` |
...
You need to answer to queries [L, R]: find the sum of maximum values on all the subsegments of subsegment [L, R] of a given array.
