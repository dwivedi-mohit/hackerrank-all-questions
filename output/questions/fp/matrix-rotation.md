...
| **Difficulty** | Hard |
| **Score** | 40 |
| **URL** | https://www.hackerrank.com/challenges/matrix-rotation |

---

## Preview

Rotate the elements of the matrix.

## Problem Statement

<sup><strong>[Here](https://www.hackerrank.com/challenges/matrix-rotation-algo) is the non-FP version of this challenge, with all languages enabled.</strong></sup>
...
1 <= _a<sub>ij</sub>_ <= 10<sup>8</sup>, where _i_ &isin; _[1..M]_ & _j_ &isin; _[1..N]_
