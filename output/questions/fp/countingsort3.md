...
- **Difficulty:** Easy
- **Max Score:** 30
- **Success Ratio:** 0.9789779089891072
- **Total Submissions:** 19646
- **Solved Count:** 19233
...
**Explanation**  
_0_ appears _1_ time, so the _0_<sup>_th_</sup> number is $1$.  
_0_ and _1_ combined appear _3_ times, so the next number is $3$.  
...
0 appears 1 time, so the 0th number is .

0 and 1 combined appear 3 times, so the next number is .
