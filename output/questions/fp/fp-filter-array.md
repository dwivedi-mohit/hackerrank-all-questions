...
- **Difficulty:** Easy
- **Max Score:** 10
- **Success Ratio:** 0.9853019934543291
- **Total Submissions:** 33610
- **Solved Count:** 33116
- **URL:** https://www.hackerrank.com/challenges/fp-filter-array
...
The first line contains the delimiter $X$. <br> 
...
Print all the integers from the array that are less than the given upper limit  in value on separate lines.
The sequence should be the same as it was in the original array.
