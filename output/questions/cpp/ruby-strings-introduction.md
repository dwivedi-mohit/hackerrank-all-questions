...
- **Difficulty:** Easy
- **Max Score:** 10
- **Success Ratio:** 0.9765775214123406
- **Total Submissions:** 11442
- **Solved Count:** 11174
- **URL:** https://www.hackerrank.com/challenges/ruby-strings-introduction

## Problem Statement

Numbers, boolean values and strings are some of the fundamental data types that we have explored in our previous challenges. In this set of tutorials, we turn our
attention to the data type referred to as *String* or *Text*
[literals](https://en.wikipedia.org/wiki/Literal_computer_programming).
