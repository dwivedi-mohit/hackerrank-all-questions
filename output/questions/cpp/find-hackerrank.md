...
- **Difficulty:** Easy
- **Max Score:** 15
- **Success Ratio:** 0.970295358649789
- **Total Submissions:** 17775
- **Solved Count:** 17247
- **URL:** https://www.hackerrank.com/challenges/find-hackerrank

## Problem Statement

At HackerRank, we always want to find out how popular we are getting every day and have scraped conversations from popular sites. Each conversation 
fits in 1 line and there are N such conversations. Each conversation has at most 1 word that says *hackerrank* (all in lowercase). We would like you to help us figure out whether a conversation:
