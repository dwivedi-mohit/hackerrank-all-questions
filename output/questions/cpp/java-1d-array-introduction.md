...
- **Difficulty:** Easy
- **Max Score:** 5
- **Success Ratio:** 0.9717932196808765
- **Total Submissions:** 355411
- **Solved Count:** 345386
...
2. Reads $n$ integers corresponding to $a_{0}, a_{1}, \ldots, a_{n-1}$ from stdin and saves each integer $a_i$ to a variable, $val$.
...
Each line $i$ of the $n$ subsequent lines contains a single integer denoting the value of element $a_{i}$.
