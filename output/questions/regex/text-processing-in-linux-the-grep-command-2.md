...
- **Difficulty:** Medium
- **Max Score:** 2
- **Success Ratio:** 0.9727844516648284
- **Total Submissions:** 33547
- **Solved Count:** 32634
- **URL:** https://www.hackerrank.com/challenges/text-processing-in-linux-the-grep-command-2
...
**Task**  
You are given a text file that will be piped into your command through STDIN. Use *grep* to display all those lines that contain the word **the** in them. <br>
*The search should NOT be sensitive to case.* <bR>
