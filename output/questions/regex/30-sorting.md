...
- **Difficulty:** Easy
- **Max Score:** 30
- **Success Ratio:** 0.9838038271036891
- **Total Submissions:** 184735
- **Solved Count:** 181743
- **URL:** https://www.hackerrank.com/challenges/30-sorting

## Problem Statement

**Objective** 	
Today, we're discussing a simple sorting algorithm called *Bubble Sort*. Check out the [Tutorial](/challenges/30-sorting/topics) tab for learning materials and an instructional video!	
...
The second line contains $n$ space-separated integers that describe $a[0], a[1], \ldots, a[n-1]$.  
...
- $2 \le n \le 600$		
- $1 \le a[i] \le 2 \times 10^6$, where $0 \le i \lt n$.
