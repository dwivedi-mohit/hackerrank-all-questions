...
- **Difficulty:** Medium
- **Max Score:** 25
- **Success Ratio:** 0.27933673469387754
- **Total Submissions:** 784
- **Solved Count:** 219
- **URL:** https://www.hackerrank.com/challenges/language-detection
...
- $\textit{The snippet will not exceed 3 kilobytes in size.}$
- $\textit{The snippet will be in one of the following languages: English, French, German, or Spanish.}$
