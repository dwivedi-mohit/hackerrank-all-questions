...
| Field | Value |
|---|---|
| **Slug** | `patient-medical-records` |
| **Domain** | react |
| **Difficulty** | Medium |
| **Score** | 60 |
| **URL** | https://www.hackerrank.com/challenges/patient-medical-records |

---

## Preview

Create a react application 'Patient Medical Records' that allows the users to view and cycle through patient's medical records
