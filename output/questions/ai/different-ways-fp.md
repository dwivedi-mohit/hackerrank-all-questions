...
- **Difficulty:** Easy
- **Max Score:** 20
- **Success Ratio:** 0.853743876836949
- **Total Submissions:** 1429
- **Solved Count:** 1220
- **URL:** https://www.hackerrank.com/challenges/different-ways-fp
...
**Note:** Haskell users can use [Data.Vector](http://hackage.haskell.org/package/vector-0.9.1/docs/Data-Vector.html) library.
