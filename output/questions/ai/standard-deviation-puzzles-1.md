...
| Field | Value |
|---|---|
| **Slug** | `standard-deviation-puzzles-1` |
| **Domain** | ai |
| **Difficulty** | Medium |
| **Score** | 10 |
| **URL** | https://www.hackerrank.com/challenges/standard-deviation-puzzles-1 |

---

## Preview

Find N where the std([1,2,3,N]) is equal to std([1,2,3]).
