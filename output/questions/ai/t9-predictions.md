...
Previously, mobile phones used the T9 dictionary, in the absence of a complete keyboard. This problem relates to predicting the word which a user wants, when he/she keys in a certain combination of numbers.
