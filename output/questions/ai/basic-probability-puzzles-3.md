...
| Field | Value |
|---|---|
| **Slug** | `basic-probability-puzzles-3` |
| **Domain** | ai |
| **Difficulty** | Easy |
| **Score** | 5 |
| **URL** | https://www.hackerrank.com/challenges/basic-probability-puzzles-3 |

---

## Preview

Some simple urn and ball selection problems, to refresh the basics of probability.
