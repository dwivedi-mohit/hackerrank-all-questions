...
| Field | Value |
|---|---|
| **Slug** | `standard-deviation-puzzles-4` |
| **Domain** | ai |
| **Difficulty** | Medium |
| **Score** | 10 |
| **URL** | https://www.hackerrank.com/challenges/standard-deviation-puzzles-4 |

---

## Preview

Computing standard deviations of the **difference** of two distributions.

## Problem Statement

Let $X$ and $Y$ be two independent "normal" random deviates with mean and standard deviation 10 and 3, and 20 and 4, respectively. Let $σ$ be the value of the standard deviation of the distribution obtained by computing the difference of the two distributions ($X$ - $Y$).
