...
| Field | Value |
|---|---|
| **Slug** | `predicting-office-space-price` |
| **Domain** | ai |
| **Difficulty** | Easy |
| **Score** | 10 |
| **URL** | https://www.hackerrank.com/challenges/predicting-office-space-price |
...
[(iframe youtube -lS35GZBxJE 560 315)]
...
Suppose we have a test case file with just one test.
Suppose our expected answer is 10

And your answer is: 9.5

d = (10 - 9.5) / 10 = 0.05

d\_adjusted = max(0.05 - 0.1,0) = 0
Score = max(1-d\_adjusted, 0) = max(1,0) = 1
