...
- **Difficulty:** Medium
- **Max Score:** 100
- **Success Ratio:** 0.13572679509632224
- **Total Submissions:** 3426
- **Solved Count:** 465
...
In order to figure out what category each document should fall under you will base it on the categories of the documents in the "[trainingdata.txt](https://s3.amazonaws.com/hr-testcases/597/assets/trainingdata.txt)" file. This file will be included with your program at runtime and will be named "trainingdata.txt".
