...
| Field | Value |
|---|---|
| **Slug** | `heros-and-heroines-villains-and-villainesses` |
| **Domain** | ai |
| **Difficulty** | Advanced |
| **Score** | 50 |
...
Given a large corpus of text involving several characters, try figuring out which are the first names corresponding to Males, and which correspond to Females.
