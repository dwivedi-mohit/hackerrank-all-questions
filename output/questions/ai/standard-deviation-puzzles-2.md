...
| Field | Value |
|---|---|
| **Slug** | `standard-deviation-puzzles-2` |
| **Domain** | ai |
| **Difficulty** | Medium |
| **Score** | 10 |
| **URL** | https://www.hackerrank.com/challenges/standard-deviation-puzzles-2 |

---

## Preview

A quick problem involving standard deviations of the heights of schoolchildren
