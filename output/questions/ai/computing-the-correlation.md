...
| Field | Value |
|---|---|
| **Slug** | `computing-the-correlation` |
| **Domain** | ai |
| **Difficulty** | Expert |
| **Score** | 20 |
| **URL** | https://www.hackerrank.com/challenges/computing-the-correlation |

---

## Preview

Given the scores obtained by students in a school leaving examination, compute the correlation coefficient between the scores in different subjects.

## Problem Statement

You are given the scores of **N** students in three different subjects - **Mathematics**,**Physics** and **Chemistry**; all of which have been graded on a scale of 0 to 100. Your task is to compute the Pearson product-moment correlation coefficient between the scores of different pairs of subjects (Mathematics and Physics, Physics and Chemistry, Mathematics and Chemistry) based on this data.
...
This is a measure of linear correlation described well [on this Wikipedia page](http://en.wikipedia.org/wiki/Pearson_product-moment_correlation_coefficient). The formula, in brief, is given by:  
...
This is followed by **N** rows containing three tab-space (_'\t'_) separated integers, **M P C** corresponding to a candidate's scores in Mathematics, Physics and Chemistry respectively.  
