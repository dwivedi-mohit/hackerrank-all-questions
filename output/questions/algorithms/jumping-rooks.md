...
Put k rooks on an n &times; n table with impassable cells in such a way that the number of pairs of rooks beating each other minimal. A rook beats another rook if they share a row or a column and there are no impassable cells between them.
