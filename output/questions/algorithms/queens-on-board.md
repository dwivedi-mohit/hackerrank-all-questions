...
| **Difficulty** | Hard |
| **Score** | 70 |
| **URL** | https://www.hackerrank.com/challenges/queens-on-board |

---

## Preview

How many ways are there to place one or more queens on a NxM board having few blocked out squares, such that, no two queens attack each other
...
Output *T* lines containing the required answer for each test case. As the answers can be really large, output them modulo 10<sup>9</sup>+7.
