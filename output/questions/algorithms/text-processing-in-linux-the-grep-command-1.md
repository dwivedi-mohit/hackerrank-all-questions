...
- **Difficulty:** Medium
- **Max Score:** 2
- **Success Ratio:** 0.9800158964460088
- **Total Submissions:** 35228
- **Solved Count:** 34524
- **URL:** https://www.hackerrank.com/challenges/text-processing-in-linux-the-grep-command-1
...
[(iframe youtube WX5Zfflvdt0 560 315)]
...
We have retained and displayed only those lines that contain the word 'the'.
 A little bit of extra care might be required to avoid retaining cases where 'the' is a suffix or prefix of some other word within the sentences!
