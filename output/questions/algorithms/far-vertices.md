...
| **Difficulty** | Hard |
| **Score** | 70 |
| **URL** | https://www.hackerrank.com/challenges/far-vertices |

---

## Preview

You have a tree and need to mark the minimum number of vertices so that the maximum distance between any two unmarked vertices be less than or equal to K.
