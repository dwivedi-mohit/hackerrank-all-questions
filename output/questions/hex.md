...
- **Difficulty:** Hard
- **Max Score:** 100
- **Success Ratio:** 0.14285714285714285
...
As this is a first player win game, we follow a slight variation to the pie rule to make the game fair. The first move of the board alone is decided by the 2nd player.

When the game starts, the board looks like this. The control of making this move is with the 2nd player.
...
The next board state will look like the one below with the control again with the 2nd player.
...
The next board state will be the one below with the control to the 1st player
...
Why do we need the integer 11 in the input?
